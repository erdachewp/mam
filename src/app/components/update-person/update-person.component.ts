...
export class UpdatePersonComponent {
  ...
  ngOnInit(){
    this.personService.getCurrentPerson(this.router.snapshot.params['_id'])
    .subscribe(
      (result: any) =>{
  ...
  update(person: any){
    this.personService.update(this.router.snapshot.params['_id'], this.updatePersonForm.value)
      .subscribe({
